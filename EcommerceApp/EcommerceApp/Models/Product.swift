...
class Product {
    ...
    static func mockProducts() -> [Product] {
        ...
        return [
            ...
            Product(id: "123", name: "Calvin Klein", imageUrl: "http://iosapptemplates.com/wp-content/uploads/2017/02/calvinkleinsuit.jpg", price: 780, description: description, category: "Suits", images: suitImages),
            Product(id: "123", name: "Red dress", imageUrl: "http://iosapptemplates.com/wp-content/uploads/2017/03/dress-1.jpeg", price: 780, description: description, category: "Dresses", images: images),
            Product(id: "123", name: "Zara", imageUrl: "http://iosapptemplates.com/wp-content/uploads/2017/03/dress-2.jpeg", price: 74, description: description, category: "Dresses", images: images),
            ...
            Product(id: "123", name: "Pimkie", imageUrl: "http://iosapptemplates.com/wp-content/uploads/2017/03/dress-5.jpeg", price: 54, description: description, category: "Dresses", images: images),
            Product(id: "123", name: "Elie Saab", imageUrl: "http://iosapptemplates.com/wp-content/uploads/2017/03/dress-6.jpeg", price: 199, description: description, category: "Dresses", images: images),
             Product(id: "43", name: "H&M", imageUrl: "http://iosapptemplates.com/wp-content/uploads/2017/03/dress-7.jpeg", price: 47, description: description, category: "Dresses", images: images),
              Product(id: "45", name: "Victoria Beckham", imageUrl: "http://iosapptemplates.com/wp-content/uploads/2017/03/dress-8.jpeg", price: 99, description: description, category: "Dresses", images: images),
        ]
    }
}
